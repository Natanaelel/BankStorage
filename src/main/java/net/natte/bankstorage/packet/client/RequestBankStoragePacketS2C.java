...
public class RequestBankStoragePacketS2C implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, RequestBankStoragePacketS2C> PACKET_CODEC = PacketCodec.tuple(
        CachedBankStorage.PACKET_CODEC,
        o->o.cachedBankStorage,
