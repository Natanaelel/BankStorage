...
//            try {
//                bankScreenHandler.getClass().getDeclaredMethod("setBankScreenSync", BankScreenHandlerSyncHandler.class).invoke(bankScreenHandler, bankScreenHandlerSyncHandler);
//            } catch (Exception e) {
//
//            }
